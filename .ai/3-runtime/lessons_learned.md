...
- **Automated Git Operations**: Before pushing a greenfield project to a user-provided repository, explicitly verify the remote history and branch structure to avoid creating disjointed parallel branches. For new architectures, creating a clean repository via the GitHub REST API is the safest strategy to ensure source control integrity.
